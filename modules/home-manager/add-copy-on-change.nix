...
# This module also support a new attribute in file configs named removeInitFile that allow to delete the link to the file create by home manager after
# the writtable copy is created. This can be useful for rare case where a program does not want any readonly file in its config directory.
